...
export default function PrivacyPage({ params }: PrivacyPageProps) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setSettings({
            ...
            allowTeamMessages: data.allowTeamMessages ?? true,
          });
        }
      } catch (error) {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      // Get the origin URL from sessionStorage or use landing page as fallback
      const originUrl = sessionStorage.getItem('delete_account_origin');
      sessionStorage.removeItem('delete_account_origin');

      // Redirect to origin URL or landing page
      window.location.href = originUrl || 'https://purvitahealth.com';
    } catch (error: any) {
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Tus reseñas y calificaciones de productos serán visibles para todos los usuarios.</p>
                  </div>
                  <Switch
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Recibe sugerencias de productos basadas en tu actividad y preferencias.</p>
                  </div>
                  <Switch
            ...
            <section>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-3 mb-6">Privacidad del Equipo</h3>
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-base font-medium text-gray-900 dark:text-white">Permitir Mensajes del Equipo</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Los miembros de tu equipo podrán enviarte mensajes. Si desactivas esta opción, el botón de mensaje no aparecerá para otros usuarios.</p>
                  </div>
                  <Switch
                    checked={settings.allowTeamMessages}
                    onCheckedChange={(value) => handleSettingChange('allowTeamMessages', value)}
                    disabled={isSaving}
                  />
                </div>
              </div>
