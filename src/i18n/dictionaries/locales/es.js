...
exports.createEsDictionary = void 0;
const default_1 = require("../default");
const createEsDictionary = (appName) => ({
    appName,
    navigation: {
        products: "Productos",
        dashboard: "Panel",
    ...
    landing: {
        ...
        opportunitySection: {
            phases: [
                ...
                },
                {
                    ...
                    visibilityTag: "Visible",
                    descriptor: "Ayuda a que cada uno de tus dos socios reclute a dos personas (tu segundo nivel).",
                ...
                },
                {
                    ...
                    descriptor: "Mantén el impulso mientras tu equipo continúa duplicándose más allá del segundo nivel.",
        ...
        contactSection: {
            ...
            contactInfo: {
                phone: "(123) 456-7890",
                email: `contacto@${(0, default_1.sanitizeAppNameForEmailDomain)(appName)}.com`,
            ...
            recipientEmail: `contacto@${(0, default_1.sanitizeAppNameForEmailDomain)(appName)}.com`,
        },
        teamSection: {
    ...
    teams: {
        ...
        locked: {
            ...
            description: "Realiza el pago mensual para desbloquear tu enlace afiliado, el material de reclutamiento y la vista genealogía.",
    ...
    compensation: {
        ...
        description: "Sincronizado en vivo con la configuración del administrador para que tu equipo vea las reglas de comisión actualizadas.",
    ...
    subscriptionManagement: {
        ...
        waitlistDescription: "Estás en lista de espera porque la comunidad alcanzó el límite de 1,000 miembros. Los beneficios se activarán en cuanto se libere un espacio.",
        statuses: {
            active: "Activa",
            past_due: "Vencida",
            unpaid: "Inactiva",
        ...
        manage: {
            ...
            cancelSuccessFallback: "Las renovaciones automáticas quedaron desactivadas. Mantendrás el acceso por el tiempo ya pagado.",
            ...
            pendingCancellationFallback: "Las renovaciones automáticas están desactivadas. Mantendrás los beneficios hasta que termine tu periodo actual.",
            dialog: {
                title: "¿Cancelar la suscripción?",
                description: "Detendremos los próximos cobros de inmediato y conservarás tus beneficios hasta que finalice el periodo de facturación en curso.",
                confirm: "Sí, cancelar",
    ...
    productDetails: {
        ...
        fallbackHeroSupporting: "ParVita es un suplemento restaurador elaborado con una mezcla de ingredientes naturales que apoya tu energía, enfoque y calma durante el día.",
        shippingLabel: "Envío",
        ...
        usageReminder: "Consulta a tu profesional de la salud antes de iniciar un nuevo suplemento.",
        ...
        defaults: {
            ...
            heroSupporting: "Formulado con botánicos ricos en nutrientes, ParVita brinda energía sostenible, mejora el enfoque y mantiene la calma sin aditivos sintéticos.",
            quickHighlights: [
            ...
            reviews: [
                {
                    ...
                    timeAgo: "Hace 2 días",
                    rating: 5,
                    comment: "Ahora ParVita es parte de mi rutina diaria y la diferencia es increíble. Mi energía se mantiene estable y me siento clara y tranquila toda la mañana.",
                },
                {
                    id: "liam-barnett",
                    author: "Liam Barnett",
                    ...
                    rating: 4,
                    comment: "Gran sabor y fácil de usar. Noté mejoras en mi enfoque desde la primera semana. ¡Muy recomendado!",
                },
                {
                    id: "amelia-ross",
                    author: "Amelia Ross",
                    ...
                    rating: 5,
                    comment: "Una dosis me mantiene equilibrada todo el día. Noté mejoras en mi digestión y ánimo. ParVita ya es parte de mi ritual.",
                },
            ],
        },
        products: {},
        ...
        home: {
            summary: {
                ...
                waitlist: {
                    ...
                    description: "Tu pago está confirmado pero alcanzamos el cupo máximo. Los beneficios se activarán automáticamente al liberar espacio.",
                },
                phaseBenefits: {
    ...
    cart: {
        ...
        testModeDescription: "Los pagos utilizan credenciales sandbox. No se realizará ningún cargo real mientras pruebas el flujo.",
        testModeInstructionsTitle: "Para probar este pago:",
        liveModeTitle: "Pagos reales activos",
        liveModeDescription: "Los pagos se procesarán con dinero real mediante el proveedor seleccionado.",
    ...
    admin: {
        ...
        warehouse: {
            ...
            description: "Registra manualmente los avances logísticos para que clientes y soporte conozcan el estado real de cada pedido.",
            empty: {
            ...
            form: {
                ...
                updating: "Guardando...",
                cancel: "Cancelar",
                autoTrackingNote: "El sistema genera automáticamente un código de seguimiento único. Compártelo con el cliente si lo solicita.",
                fields: {
        ...
        pays: {
            menuLabel: "Pagos",
            title: "Pagos",
            description: "Administra las pasarelas de pago, valida credenciales de prueba y asegura que la facturación esté lista para tu equipo.",
        },
        plans: "Planes",
        paymentHistory: {
        ...
        siteContent: {
            ...
            retry: "Reintentar",
            footerNote: "Los cambios se reflejan al instante en la landing page y en toda la aplicación.",
            submit: {
            ...
            branding: {
                ...
                description: "Se usa en el encabezado, pie de página, metadatos y en toda la experiencia.",
                fields: {
            ...
            landing: {
                ...
                description: "Personaliza el hero, la sección Sobre nosotros y las preguntas frecuentes para el idioma seleccionado.",
            },
            hero: {
                title: "Sección hero",
                description: "Define el mensaje principal y la imagen de fondo que aparecen al inicio de la página.",
                fields: {
            ...
            howItWorks: {
                title: "Cómo funciona",
                description: "Describe los pasos que deben seguir distribuidores o clientes. Debe existir al menos un paso.",
                addStep: "Agregar paso",
                removeStep: "Eliminar",
            ...
            opportunity: {
                ...
                description: "Define el roadmap y el mensaje de la cuota mensual que muestra la sección de oportunidad.",
            ...
            faqs: {
                ...
                description: "Agrega respuestas a las preguntas más comunes. Puedes dejar esta sección vacía si no la necesitas.",
            ...
            header: {
                ...
                description: "Administra los enlaces públicos, las opciones autenticadas y los llamados a la acción que aparecen en el encabezado.",
                landingLinks: {
                ...
                actions: {
                    ...
                    showCartDescription: "Permite que los usuarios accedan al carrito con un solo clic después de iniciar sesión.",
                },
            },
            footer: {
                title: "Contenido del footer",
                description: "Configura el eslogan, los enlaces de navegación y los perfiles sociales que aparecen al final de cada página.",
        ...
        appSettings: {
            ...
            pageDescription: "Ajusta las reglas globales de compensación para tu red multinivel y mantén pagos predecibles en cada nivel.",
            title: "Configuración de la compensación",
            description: "Define cómo se reparten las comisiones, los bonos de liderazgo y los cupos máximos para cada fase de tu organización.",
            ...
            errors: {
                ...
                missingCountrySelection: 'Selecciona al menos un país o activa la opción "Todos" para cada moneda configurada.',
                missingGlobalCurrency: 'Activa la opción "Todos" en al menos una moneda para cubrir el resto de países.',
                missingDefaultCurrency: 'Incluye la moneda predeterminada en las asignaciones para que funcione como respaldo global.',
            },
            toast: {
            ...
            phaseLevels: {
                ...
                description: "Define cuánto gana cada fase por compras del equipo y las recompensas personales cuando la suscripción está activa.",
            ...
            compensation: {
                ...
                visibilityDescription: "Asigna qué monedas verán los usuarios según su país en planes, productos y ganancias.",
                ...
                countriesHint: 'Cada país solo puede pertenecer a una moneda. Activa "Todos" para cubrir automáticamente el resto de países.',
                ...
                countriesDialogDescription: "Elige en qué países se mostrará esta moneda. Cada país solo puede pertenecer a una moneda.",
                countriesSearchPlaceholder: "Busca por nombre o código ISO",
                countriesAllDescription: 'Aplica esta moneda a todos los países que no estén asignados a otra moneda.',
        ...
        siteStatus: {
            ...
            description: "Controla cómo experimentan los visitantes la plataforma y personaliza los metadatos para cada estado.",
            maintenance: {
            ...
            modeSelectorDescription: "Selecciona la experiencia que verán las personas al ingresar al sitio.",
            ...
            seoSection: {
                title: "Metadatos SEO",
                description: "Personaliza los metadatos que usarán los motores de búsqueda y las redes sociales para el modo seleccionado.",
                fields: {
            ...
            appearanceSection: {
                ...
                backgroundHelper: "Proporciona una imagen para personalizar la página pública de mantenimiento o próximamente.",
                overlayHelper: "Controla qué tan oscura será la superposición sobre la imagen de fondo (0% = transparente, 100% = opaca).",
                social: {
            ...
            comingSoonSettings: {
                ...
                description: "Ajusta la cuenta regresiva y el acceso para administradores en la página de expectativa.",
                fields: {
                ...
                branding: {
                    ...
                    backgroundImageHelper: "Imagen opcional que reemplaza el fondo global cuando el modo próximamente está activo.",
                    overlayLabel: "Opacidad de la superposición",
                    overlayHelper: "Ajusta qué tanto oscurece la superposición cuando usas una imagen de fondo (0% = transparente, 100% = opaca).",
                ...
                countdown: {
                    ...
                    description: "Muestra una cuenta regresiva en la página de próximamente para reforzar la fecha de lanzamiento.",
            ...
            connectionsSection: {
                ...
                description: "Configura la integración de la lista de espera y mantén actualizados los perfiles sociales desde aquí.",
                mailchimp: {
            ...
            overviewSection: {
                ...
                description: "Supervisa el modo activo y la información clave de las integraciones.",
                statusLabel: "Estado",
                active: "Activo",
                ...
                emptyHelper: "Elige un modo para publicar una experiencia dedicada para tus visitantes.",
            },
            modeHint: "Los cambios solo afectan al modo seleccionado. Cambia de modo para configurar su SEO de forma independiente.",
            save: "Guardar cambios",
            saving: "Guardando...",
        ...
        impersonation: {
            ...
            description: "Abre una sesión segura como este miembro para depurar su experiencia. Tu sesión de administrador se reanudará cuando cierres sesión.",
        ...
        productCountrySectionDescription: "Selecciona los países donde se mostrará el botón de agregar al carrito. Los miembros fuera de esas regiones no verán el carrito ni podrán comprar.",
        productCountryManageButton: "Gestionar países",
        productCountryDialogTitle: "Elige países disponibles",
        productCountryDialogDescription: "Solo los miembros cuyo país en el perfil coincida con los seleccionados podrán agregar este producto al carrito.",
        productCountrySearchPlaceholder: "Buscar país…",
        productCountryNoResults: "Ningún país coincide con tu búsqueda.",
        productCountryHelper: "Selecciona al menos un país para habilitar el carrito. Si dejas la lista vacía, el carrito se ocultará en todos los países.",
        ...
        productDiscountSectionDescription: "Configura descuentos opcionales para este producto. Deja el tipo en 'Sin descuento' para mantener el precio original.",
        ...
        productExperienceLocaleDescription: "Proporciona contenido específico por idioma. Deja los campos vacíos para usar los valores predeterminados globales.",
        ...
        productExperienceHeroSupportingPlaceholder: "Explica el beneficio principal en una o dos oraciones.",
        ...
        productExperienceReviewsDescription: "Publica testimonios creíbles o destaca comentarios reales de la comunidad.",
    ...
    profile: {
        ...
        balanceRecharge: {
            ...
            testModeNote: "Los pagos usan credenciales de sandbox. Tu saldo se actualizará automáticamente para que puedas validar el flujo.",
            liveModeNote: "Completa el pago con el proveedor seleccionado. Tu saldo se actualizará automáticamente cuando se confirme el pago.",
            cancelLabel: "Cancelar",
    ...
    profileEarningsSettings: {
        ...
        autoPayout: {
            ...
            thresholdHelper: 'Procesaremos un pago en cuanto alcances {{threshold}}. El mínimo permitido es {{minimum}}.',
            thresholdSave: 'Guardar umbral',
            thresholdSaving: 'Guardando…',
            thresholdSuccessTitle: 'Umbral actualizado',
            thresholdSuccessDescription: 'Procesaremos pagos automáticos cuando alcances {{threshold}}.',
            thresholdErrorTitle: 'No pudimos actualizar el umbral',
            thresholdError: 'No pudimos guardar tu umbral de pago automático. Inténtalo de nuevo en unos minutos.',
            ...
            eligibleMessage: 'Tienes saldo suficiente para generar un pago automático. El dinero llegará a tu cuenta de {{provider}} en aproximadamente dos días hábiles.',
            actionCta: 'Cobrar ahora',
            processing: 'Procesando pago…',
            notEligibleMessage: 'Necesitas al menos {{threshold}} disponibles para generar un pago. Actualmente tienes {{current}}. El mínimo permitido es {{floor}}.',
            providerNotice: 'Los pagos se procesan con las credenciales configuradas por el administrador en {{provider}}.',
            processedTitle: 'Pago procesado',
            processedDescription: 'Enviamos {{amount}} a tu cuenta de {{provider}}. Debería acreditarse en aproximadamente dos días hábiles.',
            notProcessedTitle: 'Pago no procesado',
            notProcessedDescription: 'No pudimos procesar el pago automático. Verifica que tengas al menos {{threshold}} disponibles en {{provider}}.',
        ...
        paymentCadence: {
            title: 'Configuración de pagos',
            description: 'Esta configuración es establecida por el administrador y determina cómo y cuándo se procesarán tus pagos.',
            ...
            manualModeNoticeDescription: 'El administrador debe aprobar manualmente cada pago. Los pagos automáticos están deshabilitados mientras este modo esté activo.',
        },
    },
    affiliate: {
...
exports.createEsDictionary = createEsDictionary;
